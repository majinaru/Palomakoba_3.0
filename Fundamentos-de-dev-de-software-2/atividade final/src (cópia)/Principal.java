	...
	public static void main(String[] args) {
		...
		while (opte!='7'){
			...
			case '2': // inserir um diretor
					...
					setor= JOptionPane.showInputDialog(null, "Setor?");
					txtvistoria= JOptionPane.showInputDialog(null, "Quantidade de vistoria?");
					vistoria= Integer.parseInt(txtvistoria);
					txtvalor= JOptionPane.showInputDialog(null, "Valor de vistoria?");
					valor= Float.parseFloat(txtvalor);
